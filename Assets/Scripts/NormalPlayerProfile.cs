...
public class NormalPlayerProfile : IPlayerProfile
{
    private const float UntriedWeight = 1f;
    private const float EffectiveWeight = 1f;
    private const float IneffectiveWeight = 0.25f;
    private const float UnsafeWeight = 0.02f;
