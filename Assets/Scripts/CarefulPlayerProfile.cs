...
public class CarefulPlayerProfile : IPlayerProfile
{
    private const float UntriedWeight = 0.7f;
    private const float EffectiveWeight = 1f;
    private const float IneffectiveWeight = 0.05f;
    private const float UnsafeWeight = 0.005f;
    private const float ThinkingDelaySeconds = 0.75f;
